...
|-------|---------|--------|
| `mandatory-fill-in` (Skill-3) | Validates the 4 PREP cards; force_fill_batch for missing fields; gates generation | `.claude/skills/mandatory-fill-in/SKILL.md` (identical across agents 1-8) |
