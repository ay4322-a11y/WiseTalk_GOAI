...
|-------|---------|--------|
| `mandatory-fill-in` (Skill-3) | Validates the 4 SCQA cards; force_fill for missing fields; gates generation | `.claude/skills/mandatory-fill-in/SKILL.md` (identical across agents 1-8) |
