...
>
> Doc names referenced below (`PRODUCT.md`, `TASKS.md`, `DECISIONS.md`) are the project's governing docs — substitute your project's equivalents if named differently; the rules stand regardless.
...
|-----------|------------------------|
| 1. Think Before Coding | 2 Context Builder (rules) · 7 Reasoning (uncertainty behavior, escalation) |
| 2. Simplicity First | 5 Planner (granularity) · 15 Output (minimum that passes) |
| 3. Surgical Changes | 11 Tools (minimal scope) · 12 Observation (traceability) |
| 4. Goal-Driven Execution | 5 Planner (verify clauses) · 13 Reflection (loop until checks pass) |
| 5. Loop Discipline | 7 Reasoning (stop conditions) · 8 Brain Hub (escalation) · 12 Observation (trace lines) |
| Communication style | 2 Context Builder (tone/format defaults) · 15 Output Generation |
