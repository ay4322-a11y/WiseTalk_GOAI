...
| [scripts/check-pack.sh](scripts/check-pack.sh) | **The pack guard** — pre-release self-check: placeholder scan, dangling doc names, broken relative links, skills-library index sync |
